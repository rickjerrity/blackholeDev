    ...
    <Layout title="whoami">
      ...
      <div className="centeredContent">
        <p>
          ...
          write posts about here. I love listening to music, watching Twitch/YouTube, playing videogames, and keeping up with new electronics and
          tech. I&apos;ve been printed in the <a href="https://2600.com/">2600 magazine</a> (Autumn 2007 issue) and hosted one of the largest
          conference calls in the world dedicated entirely to telephone hacking (phreaking) (ConfCon 2009/2010).
        </p>
      </div>

      <div className="centeredContent">
        <p>
          I really like JavaScript, Python, and C#, and I focus on web/mobile development. I&apos;m a full-stack engineer familiar with working on
